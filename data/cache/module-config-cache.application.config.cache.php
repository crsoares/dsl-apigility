...
return array (
  ...
  array (
    ...
    array (
      ...
      array (
        'type' => 'gettext',
        'base_dir' => '/opt/lampp/htdocs/dsl-apigility/module/Application/config/../language',
        'pattern' => '%s.mo',
      ),
    ),
  ),
  ...
  array (
    ...
    'template_map' => 
    array (
      'layout/layout' => '/opt/lampp/htdocs/dsl-apigility/module/Application/config/../view/layout/layout.phtml',
      'application/index/index' => '/opt/lampp/htdocs/dsl-apigility/module/Application/config/../view/application/index/index.phtml',
      'error/404' => '/opt/lampp/htdocs/dsl-apigility/module/Application/config/../view/error/404.phtml',
      'error/index' => '/opt/lampp/htdocs/dsl-apigility/module/Application/config/../view/error/index.phtml',
      'oauth/authorize' => '/opt/lampp/htdocs/dsl-apigility/vendor/zfcampus/zf-oauth2/config/../view/zf/auth/authorize.phtml',
      'oauth/receive-code' => '/opt/lampp/htdocs/dsl-apigility/vendor/zfcampus/zf-oauth2/config/../view/zf/auth/receive-code.phtml',
    ),
    'template_path_stack' => 
    array (
      0 => '/opt/lampp/htdocs/dsl-apigility/module/Application/config/../view',
      1 => '/opt/lampp/htdocs/dsl-apigility/vendor/zfcampus/zf-apigility-documentation/config/../view',
      2 => '/opt/lampp/htdocs/dsl-apigility/vendor/zfcampus/zf-oauth2/config/../view',
    ),
    'strategies' => 
    array (
      0 => 'ViewJsonStrategy',
  ...
  array (
    ...
    array (
      'paths' => 
      array (
        0 => '/opt/lampp/htdocs/dsl-apigility/vendor/zfcampus/zf-apigility/config/../asset',
      ),
    ),
    'resolvers' => 
    array (
