    ...
    'input_filter_specs' => array(
        'Status\\V1\\Rpc\\Ping\\Validator' => array(
            0 => array(
                ...
                'filters' => array(),
                'validators' => array(),
                'description' => 'Reconhecer o pedido com um timestamp',
            ),
        ),
        'Status\\V1\\Rest\\Status\\Validator' => array(
            0 => array(
                ...
                'description' => 'Rest mensagem de Status success',
                'error_message' => 'Rest Mensagem de Status error',
            ),
            1 => array(
                'name' => 'user',
                'required' => true,
                ...
                'description' => 'Rest mensagem user success',
                'error_message' => 'Rest mensagem user error',
            ),
            2 => array(
                'name' => 'timestamp',
                'required' => false,
                ...
                'description' => 'Rest mensagem timestamp success',
                'error_message' => 'Rest mensagem timestamp error',
            ),
        ),
    ),
